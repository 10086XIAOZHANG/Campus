...
namespace CP.Campus.BLL
{
	...
	/// CpDeptInfo_BLL
	/// </summary>
	public partial class CpDeptInfo_BLL
	{
		private readonly CP.Campus.DAL.CpDeptInfo_DAL dal=new CP.Campus.DAL.CpDeptInfo_DAL();
		public CpDeptInfo_BLL()
		{}
		#region  BasicMethod
		/// <summary>
		/// 是否存在该记录
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public CP.Campus.Model.CpDeptInfo GetModelByCache(string cpId)
		{
			
			string CacheKey = "CpDeptInfoModel-" + cpId;
			...
			return (CP.Campus.Model.CpDeptInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<CP.Campus.Model.CpDeptInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<CP.Campus.Model.CpDeptInfo> DataTableToList(DataTable dt)
		{
			List<CP.Campus.Model.CpDeptInfo> modelList = new List<CP.Campus.Model.CpDeptInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				CP.Campus.Model.CpDeptInfo model;
