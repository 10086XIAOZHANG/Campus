...
namespace CP.Campus.BLL
{
	...
	/// cpLoginInfo_BLL
	/// </summary>
	public partial class cpLoginInfo_BLL
	{
		private readonly CP.Campus.DAL.cpLoginInfo_DAL dal=new CP.Campus.DAL.cpLoginInfo_DAL();
		public cpLoginInfo_BLL()
		{}
		#region  BasicMethod
		/// <summary>
		/// 是否存在该记录
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public CP.Campus.Model.cpLoginInfo GetModelByCache(string cpId)
		{
			
			string CacheKey = "cpLoginInfoModel-" + cpId;
			...
			return (CP.Campus.Model.cpLoginInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<CP.Campus.Model.cpLoginInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<CP.Campus.Model.cpLoginInfo> DataTableToList(DataTable dt)
		{
			List<CP.Campus.Model.cpLoginInfo> modelList = new List<CP.Campus.Model.cpLoginInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				CP.Campus.Model.cpLoginInfo model;
