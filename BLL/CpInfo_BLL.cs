...
namespace CP.Campus.BLL
{
	...
	/// CpInfo_BLL
	/// </summary>
	public partial class CpInfo_BLL
	{
		private readonly CP.Campus.DAL.CpInfo_DAL dal=new CP.Campus.DAL.CpInfo_DAL();
		public CpInfo_BLL()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public CP.Campus.Model.CpInfo GetModelByCache(string cpId)
		{
			
			string CacheKey = "CpInfoModel-" + cpId;
			...
			return (CP.Campus.Model.CpInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<CP.Campus.Model.CpInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<CP.Campus.Model.CpInfo> DataTableToList(DataTable dt)
		{
			List<CP.Campus.Model.CpInfo> modelList = new List<CP.Campus.Model.CpInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				CP.Campus.Model.CpInfo model;
